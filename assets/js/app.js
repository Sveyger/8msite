...
const THEMES = {
  ...
  girl_black: { '--accent': '#D9D9D9', '--accent-light': '#F2F2F2', '--accent-dark': '#787878', '--accent-glow': 'rgba(220, 220, 220, 0.32)', '--bg-primary': '#050505', '--bg-secondary': '#0B0B0B', '--bg-gradient-start': '#171717', '--bg-gradient-end': '#070707', '--bg-card': '#121212', '--text-primary': '#F2F2F2', '--text-secondary': '#C9C9C9', '--text-muted': '#8E8E8E', '--gold': '#BFBFBF', '--gold-light': '#E5E5E5' }
};
