...
const THEMES = {
  ...
  girl_white: { '--accent': '#D8D3CE', '--accent-light': '#FFFFFF', '--accent-dark': '#AAA39B', '--accent-glow': 'rgba(255, 255, 255, 0.46)', '--bg-primary': '#F7F5F1', '--bg-secondary': '#EEE9E2', '--bg-gradient-start': '#FFFFFF', '--bg-gradient-end': '#E8E1D8', '--bg-card': '#F4EFE8', '--text-primary': '#1F1B18', '--text-secondary': '#5E564F', '--text-muted': '#8E857D', '--gold': '#CFC5B8', '--gold-light': '#F7F2EB' },
