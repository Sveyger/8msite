...
const THEMES = {
  ...
  girl_black: { '--accent': '#FFFFFF', '--accent-light': '#FFFFFF', '--accent-dark': '#8A8A8A', '--accent-glow': 'rgba(255, 255, 255, 0.28)', '--bg-primary': '#000000', '--bg-secondary': '#070707', '--bg-gradient-start': '#111111', '--bg-gradient-end': '#000000', '--bg-card': '#101010', '--text-primary': '#FFFFFF', '--text-secondary': '#D1D1D1', '--text-muted': '#8C8C8C', '--gold': '#FFFFFF', '--gold-light': '#DADADA' }
};
